/** The three free-text exercise types, all built on TextAnswerForm (tilde-forgiving). */
...
export function FillBlank({ exercise, onGraded }: { exercise: FillBlankExercise; onGraded: (c: boolean) => void }) {
  return (
    <TextAnswerForm
      ...
      grade={(a) => gradeFillBlank(exercise, a)}
      expected={exercise.correctAnswer}
      onGraded={onGraded}
    />
  );
}
  ...
  return (
    <div>
      ...
      <TextAnswerForm
        ...
        grade={(a) => gradeErrorCorrection(exercise, a)}
        expected={exercise.correctSentence}
        onGraded={onGraded}
      />
    </div>
  );
  ...
  return (
    <div>
      ...
      <TextAnswerForm
        ...
        grade={(a) => gradeSentenceTransformation(exercise, a)}
        expected={exercise.correctAnswer}
        onGraded={onGraded}
      />
    </div>
