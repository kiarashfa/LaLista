 ...
 * Source of truth is data/vocabulary/master.xlsx (gitignored, owner-maintained);
...
/**
 * SPEC §4 lists masc/fem/null, but the workbook also carries neut ([neut.]),
...
export interface WordAudio {
   ...
   * gitignored and never published (SPEC §14); the UI only offers this voice
...
export interface Word {
  ...
  audio: WordAudio;
  /** Human-written hint shown proactively in the trainer (SPEC §4). */
